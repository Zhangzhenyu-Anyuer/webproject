<template>
    <div class="cart">
        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in courseList">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price">现价¥{{ course.final_price }} 原价：{{ course.price }}</el-col>
                </el-row>
            </div>
            <div class="calc">
...
export default {
    ...
    methods: {
        create_order() {
            ...
            this.$axios({
                url: this.$settings.HOST + 'order/create/',
                method: "post",
                data: {
                    pay_type: 1,
                },
        ...
        get_cart_list() {
            let token = localStorage.token || sessionStorage.token
            this.$axios({
                url: this.$settings.HOST + 'order/orderlist/',
                method: "get",
                headers: {
                    "Authorization": "jwt " + token
                }
