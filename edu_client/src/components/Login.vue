        ...
        <div class="login">
            ...
            <div class="login_box">
                ...
                <div class="inp" v-if="which">
                    ...
                    <button class="login_btn btn btn-primary" @click="get_captcha" v-if="token === ''">登录</button>
                    <button class="login_btn btn btn-primary" @click="get_ok" v-else>登录</button>
                ...
                <div class="inp" v-else>
                    ...
                    <button id="get_code" class="btn btn-primary" @click="">获取验证码</button>
                    <button class="login_btn btn btn-primary" @click="">登录</button>
                    <span class="go_login">没有账号
                    <router-link to="/register">立即注册</router-link>
                </span>
                </div>
...
export default {
    ...
    methods:{
        ...
        // 验证码正确之后的回调函数，向后台发送post请求，结果为true进行跳转到主页
