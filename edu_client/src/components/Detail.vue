        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{ course.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{
                            course.pub_lessons
                        }}课时/{{ course.lessons }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{ course.level_name }}</p>
                    <div class="sale-time">
                        <p class="sale-type">限时免费</p>
                        <p class="expire">距离结束：仅剩
                            {{ parseInt(course.active_time / (3600 * 24)) }}天
                            {{ parseInt(course.active_time / 3600 % 24) }}小时
                            {{ parseInt(course.active_time / 60 % 60) }}分 <span class="second">
                                {{ parseInt(course.active_time % 60) }}
                            </span> 秒</p>
                    </div>
            ...
            <div class="course-content">
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="(cha,index) in chapter" :key="index">
                            <p class="chapter-title"><img src="/static/image/avatar1.svg"
                                                          alt="">第{{ index + 1 }}章·{{ cha.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(lesson,key) in cha.coursesections">
                                    <p class="name"><span class="index">{{ index + 1 }}-{{ key + 1 }}</span>
                                        {{ lesson.name }}<span :class="lesson.free_trail ? 'free' : ''">免费</span>
                                    </p>
